                                    ...
                                    <ul class="ht-menu">
                                        ...
                                        <li>
                                            ...
                                            <div class="language ht-language">
                                                <ul class="ht-setting-list">
                                                    <li class="active"><a href="#"><img src="{{ asset('forntend/images/menu/flag-icon/1.jpg')}}" alt="">English</a></li>
                                                    <li><a href="#"><img src="{{ asset('forntend/images/menu/flag-icon/2.jpg')}}" alt="">Français</a></li>
                                                </ul>
                                            </div>
                                        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index.html">
                                        <img src="{{ asset('forntend/images/menu/logo/2.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                                                ...
                                                <ul class="minicart-product-list">
                                                    <li>
                                                        <a href="single-product.html" class="minicart-product-image">
                                                            <img src="{{ asset('forntend/images/product/small-size/1.jpg')}}" alt="cart products">
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a href="single-product.html" class="minicart-product-image">
                                                            <img src="{{ asset('forntend/images/product/small-size/2.jpg')}}" alt="cart products">
                                                        </a>
                                                        <div class="minicart-product-details">
                                                            <h6><a href="single-product.html">Aenean eu tristique</a></h6>
                                                            <span>£40 x 1</span>
